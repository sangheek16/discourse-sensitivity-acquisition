...
# bash scripts/collect-generations-non-instruct.sh meta-llama/Meta-Llama-3-8B llama-3-8b

bash scripts/collect-generations-non-instruct.sh Qwen/Qwen2.5-0.5B qwen2.5-500m

bash scripts/collect-generations-non-instruct.sh Qwen/Qwen2.5-1.5B qwen2.5-1.5b

bash scripts/collect-generations-non-instruct.sh Qwen/Qwen2.5-3B qwen2.5-3b

bash scripts/collect-generations-non-instruct.sh Qwen/Qwen2.5-7B qwen2.5-7b

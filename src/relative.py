...
def main(args):
    ...
    for batch in tqdm(eval_dl):
        ...
        no_control = lm.conditional_score(
            no_prefix, ["this is a sentence."] * len(no_prefix), bos_token=bos_tok, bow_correction=True
        )

        wait_control = lm.conditional_score(
            wait_prefix, ["this is a sentence."] * len(no_prefix), bos_token=bos_tok, bow_correction=True
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--results-dir", type=str, default="data/results/kim22-arc-dcpmi"
    )
